...
import 'package:menifi/pages/MovieScreens/NowPlayingMoviesScreen.dart';
import 'dart:convert';
import 'dart:async';
...
class NowPlayinMoviesSlider extends StatefulWidget {
  const NowPlayinMoviesSlider({super.key});

  @override
  State<NowPlayinMoviesSlider> createState() => _NowPlayinMoviesSliderState();
}

class _NowPlayinMoviesSliderState extends State<NowPlayinMoviesSlider> {
  int pageNumber = 1;
  late Map data;
          ...
          isLoading
              ...
              : Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemCount: NowPlayingMovies.isNotEmpty
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => MovieSearchScreen(
                                          movieName: NowPlayingMovies[index]
                                                  ['title'] ??
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  Image.network(
                                    'https://image.tmdb.org/t/p/w185/${NowPlayingMovies[index]['poster_path']}',
                                    fit: BoxFit.cover,
                                    height: 185,
                                    width: 120,
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            color: const Color.fromARGB(
                                                255, 255, 17, 0)),
                                        child: Text(
                                          " ${double.parse(NowPlayingMovies[index]['vote_average'].toStringAsFixed(1))}",

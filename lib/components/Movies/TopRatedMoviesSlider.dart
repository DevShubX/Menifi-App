...
class TopRatedMoviesSlider extends StatefulWidget {
  const TopRatedMoviesSlider({super.key});
...
class _TopRatedMoviesSliderState extends State<TopRatedMoviesSlider> {
  ...
  Future getMovies() async {
    http.Response response = await http.get(Uri.parse(
        'https://api.themoviedb.org/3/movie/top_rated?api_key=$key&language=en-US&page=$pageNumber'));
          ...
          isLoading
              ...
              : Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemCount:
                          TopRatedMovies.isNotEmpty ? TopRatedMovies.length : 0,
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => MovieSearchScreen(
                                          movieName: TopRatedMovies[index]
                                                  ['title'] ??
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  Image.network(
                                    'https://image.tmdb.org/t/p/w185/${TopRatedMovies[index]['poster_path']}',
                                    height: 185,
                                    width: 120,
                                    fit: BoxFit.cover,
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            color: const Color.fromARGB(
                                                255, 255, 17, 0)),
                                        child: Text(
                                          " ${double.parse(TopRatedMovies[index]['vote_average'].toStringAsFixed(1))}",

...
class PopularMangaSlider extends StatefulWidget {
  const PopularMangaSlider({super.key});

  @override
  State<PopularMangaSlider> createState() => _PopularMangaSliderState();
}

class _PopularMangaSliderState extends State<PopularMangaSlider> {
  int pageNumber = 1;
  late Map data;
  List? Manga = [];
  bool isLoading = true;

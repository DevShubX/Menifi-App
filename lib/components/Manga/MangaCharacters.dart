...
class MangaCharacters extends StatefulWidget {
  const MangaCharacters({super.key, this.malId});
  final malId;
  @override
  State<MangaCharacters> createState() => _MangaCharactersState();
}

class _MangaCharactersState extends State<MangaCharacters> {
  List data = [];
  bool isLoading = true;
  ...
  Future getAnimeCharac(String idMal) async {
    ...
    http.Response response = await http
        .get(Uri.parse('https://api.jikan.moe/v4/manga/$idMal/characters'));

...
import 'package:menifi/pages/MangaScreens/TopMangaScreen.dart';
import 'dart:convert';
import 'dart:async';
...
class TopMangaSlider extends StatefulWidget {
  const TopMangaSlider({super.key});

  @override
  State<TopMangaSlider> createState() => _TopMangaSliderState();
}

class _TopMangaSliderState extends State<TopMangaSlider> {
  int pageNumber = 1;
  late Map data;
  List? Manga = [];
  bool isLoading = true;
  ...
  Future getManga() async {
    http.Response response = await http.get(Uri.parse(
        'https://redux-api-wine.vercel.app/api/top100/manga?page=${pageNumber}&count=${count}'));

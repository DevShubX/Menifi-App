...
import 'package:menifi/pages/ComicScreens/PopularVolumesScreen.dart';
import 'dart:convert';
import 'dart:async';

import '../Skeletons/ImagesSliderSkeleton.dart';

class ComicSliderPopular extends StatefulWidget {
  const ComicSliderPopular({super.key});

  @override
  State<ComicSliderPopular> createState() => _ComicSliderPopularState();
}

class _ComicSliderPopularState extends State<ComicSliderPopular> {
  List data = [];
  bool isLoading = true;

...
class TopRatedTvShowsScreen extends StatefulWidget {
  const TopRatedTvShowsScreen({super.key});

  @override
  State<TopRatedTvShowsScreen> createState() => _TopRatedTvShowsScreenState();
}

class _TopRatedTvShowsScreenState extends State<TopRatedTvShowsScreen> {

...
class OnTheAirTvShowsScreen extends StatefulWidget {
  const OnTheAirTvShowsScreen({super.key});

  @override
  State<OnTheAirTvShowsScreen> createState() => _OnTheAirTvShowsScreenState();
}

class _OnTheAirTvShowsScreenState extends State<OnTheAirTvShowsScreen> {
                            ...
                            child: Column(
                              ...
                              children: [
                                Expanded(
                                  flex: 0,
                                  child: Text(
                                    '${item['name'] ?? item['original_name'] ?? "NA"}',
                                    maxLines: 3,

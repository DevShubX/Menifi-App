...
class TrendingMangaScreen extends StatefulWidget {
  const TrendingMangaScreen({super.key});

  @override
  State<TrendingMangaScreen> createState() => _TrendingMangaScreenState();
}

class _TrendingMangaScreenState extends State<TrendingMangaScreen> {

...
class FavouriteMangaScreen extends StatefulWidget {
  const FavouriteMangaScreen({super.key});

  @override
  State<FavouriteMangaScreen> createState() => _FavouriteMangaScreenState();
}

class _FavouriteMangaScreenState extends State<FavouriteMangaScreen> {

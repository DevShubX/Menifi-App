...
class PopularStoryArcScreen extends StatefulWidget {
  const PopularStoryArcScreen({super.key});

  @override
  State<PopularStoryArcScreen> createState() => _PopularStoryArcScreenState();
}

class _PopularStoryArcScreenState extends State<PopularStoryArcScreen> {
  ...
  Future getcomics() async {
    http.Response response = await http.get(Uri.parse(
        'https://comics-api-wine.vercel.app/api/story-arcs?page=$pageNumber'));

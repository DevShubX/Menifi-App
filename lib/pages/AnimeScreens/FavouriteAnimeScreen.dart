...
class FavouriteAnimeScreen extends StatefulWidget {
  const FavouriteAnimeScreen({super.key});

  @override
  State<FavouriteAnimeScreen> createState() => _FavouriteAnimeScreenState();
}

class _FavouriteAnimeScreenState extends State<FavouriteAnimeScreen> {
  ...
  Future getAnimes() async {
    ...
    setState(() {
      pageNumber++;
      Anime!.addAll(data['data']['Page']['media']);
      isLoading = false;
    });
  }
